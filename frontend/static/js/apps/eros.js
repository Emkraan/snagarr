    ...
    testErosButton.addEventListener('click', function() {
        ...
        if (!apiUrlInput.value || !apiKeyInput.value) {
            if (typeof snagarrUI !== 'undefined') {
                snagarrUI.showNotification('Please enter both API URL and API Key for Eros', 'error');
            } else {
        ...
        SnagarrUtils.fetchWithTimeout('/api/eros/test-connection', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if (erosStatusIndicator) {
                if (data.success) {
                    ...
                    if (typeof snagarrUI !== 'undefined') {
                         snagarrUI.showNotification('Successfully connected to Eros', 'success');
                    }
                    ...
                    if (typeof snagarrUI !== 'undefined') {
                        snagarrUI.showNotification(data.message || 'Failed to connect to Eros', 'error');
                    } else {
        ...
        .catch(error => {
            ...
            if (typeof snagarrUI !== 'undefined') {
                snagarrUI.showNotification('Error testing connection: ' + error.message, 'error');
            } else {
